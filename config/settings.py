...
)  # Replace with your project ID or set env var
GCP_REGION = os.getenv("GCP_REGION", "us")  # Choose your preferred region

# --- Cloud Storage Buckets ---
GCS_RAW_DOCUMENTS_BUCKET = os.getenv(
    "GCS_RAW_DOCUMENTS_BUCKET", f"gs://{GCP_PROJECT_ID}-iaa-raw-docs"
)
GCS_PROCESSED_DOCUMENTS_BUCKET = os.getenv(
    "GCS_PROCESSED_DOCUMENTS_BUCKET", f"gs://{GCP_PROJECT_ID}-iaa-processed-docs"
)
GCS_MODEL_ARTIFACTS_BUCKET = os.getenv(
    "GCS_MODEL_ARTIFACTS_BUCKET", f"gs://{GCP_PROJECT_ID}-iaa-model-artifacts"
)
...
DOCUMENT_AI_INVOICE_PROCESSOR_ID = os.getenv(
    "DOCUMENT_AI_INVOICE_PROCESSOR_ID", "your-invoice-processor-id"
)
DOCUMENT_AI_RECEIPT_PROCESSOR_ID = os.getenv(
    "DOCUMENT_AI_RECEIPT_PROCESSOR_ID", "your-receipt-processor-id"
)
# You'll need to create these processors in Google Cloud Console Document AI service

# --- Vertex AI Endpoints ---
VERTEX_AI_CATEGORIZATION_ENDPOINT_ID = os.getenv(
    "VERTEX_AI_CATEGORIZATION_ENDPOINT_ID", "your-cat-endpoint-id"
)
VERTEX_AI_ANOMALY_ENDPOINT_ID = os.getenv(
    "VERTEX_AI_ANOMALY_ENDPOINT_ID", "your-anomaly-endpoint-id"
)
